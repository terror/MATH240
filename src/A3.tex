...
\begin{proof}
  Suppose $x \in \Z$ is even. \spacing
  ...
  \noindent
  Let $l = 4k^3 - 2k + 1$, $l \in \Z$. \spacing
...
\begin{proof}
  Suppose $log_{2}5$ is rational. \spacing
  ...
  \noindent
  Since all $5^n, \: n \in Z$ are odd and all $2^m, \: m \in Z$ are even, we've
